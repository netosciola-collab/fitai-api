-- CreateTable Exercise (sem dependências)
...
-- CreateTable Achievement (sem dependências)
...
-- CreateTable WorkoutPlan (depende de User)
...
-- CreateTable WorkoutDay (depende de WorkoutPlan)
...
-- CreateTable WorkoutExercise (depende de WorkoutDay e Exercise)
...
-- CreateTable CheckIn (depende de User)
...
-- CreateTable WorkoutSession (depende de User e WorkoutDay)
...
-- CreateTable ExerciseLog (depende de WorkoutSession e Exercise)
...
-- CreateTable SetLog (depende de ExerciseLog)
...
-- CreateTable BodyLog (depende de User)
...
-- CreateTable NutritionLog (depende de User)
...
-- CreateTable FormAnalysis (depende de User e Exercise)
...
-- CreateTable UserAchievement (depende de User e Achievement)
...
-- CreateTable Notification (depende de User)
